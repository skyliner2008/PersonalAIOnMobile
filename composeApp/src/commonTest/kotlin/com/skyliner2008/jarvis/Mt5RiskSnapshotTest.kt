...
import com.skyliner2008.jarvis.automation.backtest.RiskEngine
import com.skyliner2008.jarvis.tools.trading.Mt5AccountInfo
import com.skyliner2008.jarvis.tools.trading.Mt5TerminalSnapshot
    ...
    fun snapshot_account_can_feed_risk_engine_without_server_call() {
        ...
        val result = RiskEngine.evaluate(
            ...
            proposal = RiskEngine.Proposal(
                strategyGate = com.skyliner2008.jarvis.automation.backtest.RiskGate.Decision.PASS,
                entry = 100.0,
                stopLoss = 98.0,
