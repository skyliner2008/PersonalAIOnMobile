...
import com.skyliner2008.jarvis.automation.backtest.DemoAccountConfig
import com.skyliner2008.jarvis.automation.backtest.DemoTradingEngine
    ...
    fun demo_risk_sizing_includes_round_turn_cost_budget() {
        val engine = DemoTradingEngine(
            config = DemoAccountConfig(
                id = "risk-demo",
                name = "Risk Demo",
                costProfile = com.skyliner2008.jarvis.automation.backtest.DemoCostProfile(
                    spreadPrice = 0.20,
