...
object AlertFieldCatalog {
    ...
    val SIGNAL_ALERT = AlertToolOption(
        ...
        fields = listOf(
            ...
            AlertFieldOption("ema14_60_near_cross", "EMA 14/60 Near-Cross (1=เกือบตัดกัน)", "1 = EMA14 และ EMA60 กำลังบีบตัวเข้าหากันในระยะกระชั้นชิด"),
            AlertFieldOption("ema14_60_near_cross_side", "ทิศทาง Near-Cross (BUY/SELL)", "BUY = กำลังจะตัดขึ้น (Golden Cross) | SELL = กำลังจะตัดลง (Death Cross) — ใช้กับ ==", isNumeric = false),
            AlertFieldOption("ema14_60_state", "EMA 14/60 State", "BULLISH / BEARISH — ใช้กับ ==", isNumeric = false),
            AlertFieldOption("ema14_60_spread", "EMA 14-60 Spread (ระยะห่าง)", "ระยะห่างระหว่างเส้น EMA 14 และ 60"),
            AlertFieldOption("ema14", "EMA 14", "ราคาเส้น EMA 14"),
            AlertFieldOption("ema60", "EMA 60", "ราคาเส้น EMA 60"),
