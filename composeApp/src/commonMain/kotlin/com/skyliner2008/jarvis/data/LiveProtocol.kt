...
object LiveProtocol {
    ...
    fun delegatedAck(toolName: String): String =
        "$DELEGATED_PREFIX ส่งงาน $toolName ให้ผู้ช่วยทำเบื้องหลังแล้ว — ตอบรับผู้ใช้สั้นๆ 1 ประโยคว่ากำลังดึงข้อมูลให้ " +
            "แล้วหยุด ห้ามเดาผลหรือพูดตัวเลขใดๆ เมื่อผู้ช่วยทำเสร็จ ระบบจะส่งผลมาให้รายงานเอง " +
            "ระหว่างนี้ผู้ใช้ถามเรื่องอื่นต่อได้ตามปกติ"
