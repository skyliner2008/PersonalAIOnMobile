...
class LlmProviderRegistry(private val client: HttpClient) {
    ...
    fun registerGemini(apiKey: String) {
        ...
        register(GeminiLlmProvider(com.skyliner2008.jarvis.data.GeminiService(client, apiKey, com.skyliner2008.jarvis.data.ModelConfig.DEFAULT_MAIN_MODEL), client))
    }
    ...
    private fun createTempProvider(providerId: String, apiKey: String): LlmProvider? {
        ...
        return when (providerId.lowercase()) {
            "gemini" -> GeminiLlmProvider(com.skyliner2008.jarvis.data.GeminiService(client, apiKey, com.skyliner2008.jarvis.data.ModelConfig.DEFAULT_MAIN_MODEL), client)
