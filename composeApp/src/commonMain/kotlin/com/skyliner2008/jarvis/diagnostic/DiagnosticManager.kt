package com.skyliner2008.jarvis.diagnostic
...
class DiagnosticManager(
    ...
    private fun checkDatabaseIntegrity(): DiagnosticResult {
        ...
        return try {
            ...
            val archivalCount = runCatching {
                com.skyliner2008.jarvis.db.JarvisDatabaseHolder.database
    ...
    private fun checkMemoryConsolidation(): DiagnosticResult {
        ...
        return try {
            val q = com.skyliner2008.jarvis.db.JarvisDatabaseHolder.database?.jarvisDatabaseQueries
