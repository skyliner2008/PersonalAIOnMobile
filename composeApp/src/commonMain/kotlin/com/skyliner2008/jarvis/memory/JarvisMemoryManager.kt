package com.skyliner2008.jarvis.memory

import com.skyliner2008.jarvis.data.ConversationTurn
import com.skyliner2008.jarvis.data.embedding.EMBEDDING_TARGET_DIMS
import com.skyliner2008.jarvis.data.embedding.EmbeddingProvider
...
class JarvisMemoryManager(private val database: JarvisDatabase) {
    ...
    suspend fun performSleepCycle(embeddingProvider: EmbeddingProvider, geminiService: com.skyliner2008.jarvis.data.GeminiService, limitMsgs: Long = 100): Boolean {
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                result.edgesToCreateOrUpdate.forEach { edge ->
                    ...
                    if (sourceNode != null && targetNode != null) {
                        try {
                            ...
                            com.skyliner2008.jarvis.logError("DreamEngine", "Edge update failed", e)
                        }
                    }
                }
                ...
                com.skyliner2008.jarvis.logError("DreamEngine", "Sleep cycle failed: ${e.message}", e)
                false
            }
        }
    }
