...
class SignalMarkerProvider(private val smcApi: SmcApiService) {
    ...
    fun compute(
        ...
        entryParams: Map<String, com.skyliner2008.jarvis.automation.backtest.EntryParams> = emptyMap(),
        ...
        val epMOM = entryParams["MOM"] ?: com.skyliner2008.jarvis.automation.backtest.EntryParams()
        val epTR = entryParams["TR"] ?: com.skyliner2008.jarvis.automation.backtest.EntryParams()
        val epREV = entryParams["REV"] ?: com.skyliner2008.jarvis.automation.backtest.EntryParams()
        val epDC = entryParams["DC"] ?: com.skyliner2008.jarvis.automation.backtest.EntryParams()
        val ep52H = entryParams["52H"] ?: com.skyliner2008.jarvis.automation.backtest.EntryParams()
        val epE = entryParams["E"] ?: com.skyliner2008.jarvis.automation.backtest.EntryParams()
        val epUT = entryParams["UT"] ?: com.skyliner2008.jarvis.automation.backtest.EntryParams()
