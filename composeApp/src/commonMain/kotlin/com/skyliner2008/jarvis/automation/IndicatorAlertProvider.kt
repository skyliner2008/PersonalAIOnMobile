...
class IndicatorAlertProvider(private val smcApi: SmcApiService) {
    ...
    companion object {
        ...
        fun normalizeTf(tf: String): String = com.skyliner2008.jarvis.tools.trading.TaIndicators.normalizeTimeframe(tf)
    ...
    suspend fun fetch(rawSymbol: String): Map<String, String> {
        ...
        val supertrend = com.skyliner2008.jarvis.tools.trading.TaIndicators.supertrend(highs, lows, closes)
