...
| ควบคุมแอป | 🟡 45% | กด/พิมพ์/เลื่อนได้ แต่ tap พิกัดค้างได้ ส่งข้อความไม่ได้ ไม่มี long-press/swipe ข้าง |
| รู้ว่าอยู่หน้าไหน | 🟡 45% | รู้แค่ package + activity + ข้อความ — ไม่เห็นภาพจริง อ่านได้ window เดียว |
| รู้ว่าปุ่มอยู่ตรงไหน | 🔴 15% | อ่านพิกัดมาแล้วแต่ไม่ส่งให้ AI + ปุ่มไอคอนถูกกรองทิ้ง |
