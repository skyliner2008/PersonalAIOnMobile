...
- [[69_OHLCV_Indicator_Foundation_V27]] - V27 OHLCV store (TV-only, source-aware, incremental, retention 6000) + indicator correctness per TF
- [[70_WakeTrigger_Architecture_V28]] - V28 ระบบปลุก AI: ปัจจัย ~115 ตัว 15 หมวด = นาฬิกาปลุก ไม่ใช่ข้อสรุป + conditional learning
